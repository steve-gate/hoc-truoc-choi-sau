...
$stage=Join-Path $root ".build-v765"
...
Write-Host ""
Write-Host "==> FocusLock V7.6.5 - Settings unlock + add app/web UX fix" -ForegroundColor Cyan
...
if($ver -notlike "7.6.5*"){ throw "Sai App version: $ver" }

Start-Process $appExe

Write-Host ""
Write-Host "============================================================" -ForegroundColor Green
Write-Host "OK - FOCUSLOCK V7.6.5 INSTALLED" -ForegroundColor Green
Write-Host "Typing challenge: case-insensitive + whitespace normalized" -ForegroundColor Green
Write-Host "App/Web add errors: visible immediately" -ForegroundColor Green
Write-Host "Browser core V7.6.4: UNCHANGED" -ForegroundColor Green
Write-Host "publish\Data: UNTOUCHED" -ForegroundColor Green
Write-Host "============================================================" -ForegroundColor Green
exit 0
